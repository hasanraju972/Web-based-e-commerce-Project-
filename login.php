...
<div class="form-group">
    <label class="info-title" for="captcha">Captcha <span>*</span></label>
    <?php
    ...
    $sum = $num1 + $num2;
    ?>
    <input type="text" name="captcha_input" class="form-control unicase-form-control text-input" id="captcha" placeholder="<?php echo $num1 . ' + ' . $num2 . ' = '; ?>">
...
<div class="error-message">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $userInput = isset($_POST['captcha_input']) ? (int)$_POST['captcha_input'] : 0;
        if ($userInput !== $sum) {
